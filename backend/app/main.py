...
from app.api import auth, bank_oauth, budgets, companies, deals, dictionaries, imports, imports_bank, integrations, operations, quickfilters, recurring, reports, rules
...
app.include_router(imports_bank.router)
